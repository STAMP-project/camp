...
from camp.realize.model.realization import RegExpFileSubstNode
from camp.realize.dao.daos import FileContentCommiter
...
substituion1: 
 ...
 '''
	...
	@patch('camp.realize.plugins.regexp.FileContentCommiter')
	...
	def test_file_commiter(self):
		...
		file_commiter.set_read_file('tests/realize/resources/simple_e2e_regexp/Dockerfile')
