...
from camp.realize.plugins.regexp import RegExp
...
variable1:
 value1:
  operations:
   - substituion1:
      engine: regexp
      filename: "tests/realize/resources/simple_e2e_regexp/tmp/Dockerfile"
...
'''
		...
		self.test_2_sub_tmp_path = "tests/realize/resources/simple_e2e_regexp/tmp"
		self.test_2_sub_source_docker = "tests/realize/resources/simple_e2e_regexp/Dockerfile"
		self.test_2_sub_first_sub = "tests/realize/resources/simple_e2e_regexp/exp/Dockerfile_subst1"
		self.test_2_sub_second_sub = "tests/realize/resources/simple_e2e_regexp/exp/Dockerfile_subst1_2"
