...
class TestE2ERealization(unittest.TestCase):
	...
	def setUp(self):
		self.src_dockerimage = "tests/realize/resources/simple_e2e_regexp/Dockerfile"
		self.sub_first_sub = "tests/realize/resources/simple_e2e_regexp/exp/Dockerfile_subst1"
		self.sub_second_sub = "tests/realize/resources/simple_e2e_regexp/exp/Dockerfile_subst1_2"
		self.src_realmodel = "tests/realize/resources/simple_e2e_regexp/test_realmodel.yaml"

		self.src_prodmodel = "tests/realize/resources/simple_e2e_regexp/product_model.yaml"

		self.tmp_dir = "tests/realize/resources/simple_e2e_regexp/tmp"

		self.prod1_image_path = os.path.join(self.tmp_dir, 'product1', 'images')
		self.prod2_image_path = os.path.join(self.tmp_dir, 'product2', 'images')
